...
- On Next-Gen and later (1.10.980, 1.11.x): the
  [Runtime Database](https://www.nexusmods.com/fallout4/mods/108394)
  (`Data\F4SE\Plugins\f4rd-runtime.bin`), which is how one DLL finds its
  way on every game version. On 1.10.163 it is optional.

One DLL for all versions. 1.10.163 is what this mod is developed and
played on; Next-Gen and 1.11.x are built for and rely on testers.
...
by Sator. CommonLibF4RD is MIT and is not affected by that.
